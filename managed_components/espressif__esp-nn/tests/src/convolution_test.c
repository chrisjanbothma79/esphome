...
void esp_nn_fully_connected_per_ch_s8_test() {
  ...
  for (int itr = 0; itr < 15; itr++) {
    ...
    /* C function */
    esp_nn_fully_connected_per_ch_s8_ansi(input, input_offset, row_len, filter_data, filter_offset, NULL, output_c,
                                          out_channels, out_offset, out_shift, out_mult, activation_min,
                                          activation_max);
    ...
    /* Optimized function */
    esp_nn_fully_connected_per_ch_s8(input, input_offset, row_len, filter_data, filter_offset, NULL, output_opt,
                                     out_channels, out_offset, out_shift, out_mult, activation_min, activation_max);
