...
static void register_mdns_query_a(void) {
  ...
  const esp_console_cmd_t cmd_init = {.command = "mdns_query_a",
...
static void register_mdns_query_aaaa(void) {
  ...
  const esp_console_cmd_t cmd_init = {.command = "mdns_query_aaaa",
...
static void register_mdns_query_srv(void) {
  ...
  const esp_console_cmd_t cmd_init = {.command = "mdns_query_srv",
...
static void register_mdns_query_txt(void) {
  ...
  const esp_console_cmd_t cmd_init = {.command = "mdns_query_txt",
...
static void register_mdns_query_ptr(void) {
  ...
  const esp_console_cmd_t cmd_init = {.command = "mdns_query_ptr",
...
static void register_mdns_query_ip(void) {
  ...
  const esp_console_cmd_t cmd_init = {.command = "mdns_query_ip",
...
static void register_mdns_query_svc(void) {
  ...
  const esp_console_cmd_t cmd_init = {.command = "mdns_query_svc",
...
static void register_mdns_init(void) {
  ...
  const esp_console_cmd_t cmd_init = {.command = "mdns_init",
...
static void register_mdns_free(void) {
  const esp_console_cmd_t cmd_free = {
      .command = "mdns_free", .help = "Stop MDNS Server", .hint = NULL, .func = &cmd_mdns_free, .argtable = NULL};
...
static void register_mdns_set_hostname(void) {
  ...
  const esp_console_cmd_t cmd_set_hostname = {.command = "mdns_set_hostname",
...
static void register_mdns_set_instance(void) {
  ...
  const esp_console_cmd_t cmd_set_instance = {.command = "mdns_set_instance",
...
static void register_mdns_service_add(void) {
  ...
  const esp_console_cmd_t cmd_add = {.command = "mdns_service_add",
...
static int cmd_mdns_service_remove(int argc, char **argv) {
  ...
  ESP_ERROR_CHECK(
      mdns_service_remove_for_host(instance, mdns_remove_args.service->sval[0], mdns_remove_args.proto->sval[0], host));
  return 0;
}
...
static void register_mdns_service_remove(void) {
  ...
  const esp_console_cmd_t cmd_remove = {.command = "mdns_service_remove",
...
static int cmd_mdns_service_instance_set(int argc, char **argv) {
  ...
  if (!mdns_service_instance_set_args.service->sval[0] || !mdns_service_instance_set_args.proto->sval[0] ||
      !mdns_service_instance_set_args.instance->sval[0]) {
    printf("ERROR: Bad arguments!\n");
    return 1;
  }
  const char *host = NULL;
  ...
  esp_err_t err = mdns_service_instance_name_set_for_host(old_instance, mdns_service_instance_set_args.service->sval[0],
                                                          mdns_service_instance_set_args.proto->sval[0], host,
                                                          mdns_service_instance_set_args.instance->sval[0]);
  if (err != ESP_OK) {
...
static void register_mdns_service_instance_set(void) {
  ...
  mdns_service_instance_set_args.old_instance =
      arg_str0("i", "old_instance", "<old_instance>", "Instance name before update");
  mdns_service_instance_set_args.end = arg_end(4);

  const esp_console_cmd_t cmd_add = {.command = "mdns_service_instance_set",
...
static int cmd_mdns_service_port_set(int argc, char **argv) {
  ...
  if (!mdns_service_port_set_args.service->sval[0] || !mdns_service_port_set_args.proto->sval[0] ||
      !mdns_service_port_set_args.port->ival[0]) {
    printf("ERROR: Bad arguments!\n");
    return 1;
  }
  ...
  esp_err_t err = mdns_service_port_set_for_host(instance, mdns_service_port_set_args.service->sval[0],
                                                 mdns_service_port_set_args.proto->sval[0], host,
                                                 mdns_service_port_set_args.port->ival[0]);
  if (err != ESP_OK) {
...
static void register_mdns_service_port_set(void) {
  ...
  const esp_console_cmd_t cmd_add = {.command = "mdns_service_port_set",
...
static int cmd_mdns_service_txt_replace(int argc, char **argv) {
  ...
  ESP_ERROR_CHECK(mdns_service_txt_set_for_host(instance, mdns_txt_replace_args.service->sval[0],
                                                mdns_txt_replace_args.proto->sval[0], host, items,
                                                mdns_txt_replace_args.txt->count));
  mdns_mem_free(items);
  return 0;
}
...
static void register_mdns_service_txt_replace(void) {
  ...
  const esp_console_cmd_t cmd_txt_set = {.command = "mdns_service_txt_replace",
...
static int cmd_mdns_service_txt_set(int argc, char **argv) {
  ...
  ESP_ERROR_CHECK(mdns_service_txt_item_set_for_host(instance, mdns_txt_set_args.service->sval[0],
                                                     mdns_txt_set_args.proto->sval[0], host,
                                                     mdns_txt_set_args.var->sval[0], mdns_txt_set_args.value->sval[0]));
  return 0;
}
...
static void register_mdns_service_txt_set(void) {
  ...
  const esp_console_cmd_t cmd_txt_set = {.command = "mdns_service_txt_set",
...
static int cmd_mdns_service_txt_remove(int argc, char **argv) {
  ...
  if (!mdns_txt_remove_args.service->sval[0] || !mdns_txt_remove_args.proto->sval[0] ||
      !mdns_txt_remove_args.var->sval[0]) {
    printf("ERROR: Bad arguments!\n");
    return 1;
  }
  const char *instance = NULL;
  ...
  ESP_ERROR_CHECK(mdns_service_txt_item_remove_for_host(instance, mdns_txt_remove_args.service->sval[0],
                                                        mdns_txt_remove_args.proto->sval[0], host,
                                                        mdns_txt_remove_args.var->sval[0]));
  return 0;
}
...
static void register_mdns_service_txt_remove(void) {
  ...
  const esp_console_cmd_t cmd_txt_remove = {.command = "mdns_service_txt_remove",
...
static void register_mdns_service_remove_all(void) {
  const esp_console_cmd_t cmd_free = {.command = "mdns_service_remove_all",
...
static int cmd_mdns_lookup_service(int argc, char **argv) {
  ...
  if (!mdns_lookup_service_args.instance->sval[0] || !mdns_lookup_service_args.service->sval[0] ||
      !mdns_lookup_service_args.proto->sval[0]) {
    printf("ERROR: Bad arguments!\n");
    return 1;
  }
  mdns_result_t *results = NULL;
  esp_err_t err =
      lookup_service(mdns_lookup_service_args.instance->count ? mdns_lookup_service_args.instance->sval[0] : NULL,
...
static void register_mdns_lookup_service(void) {
  ...
  const esp_console_cmd_t cmd_lookup_service = {.command = "mdns_service_lookup",
...
static void register_mdns_delegate_host(void) {
  ...
  const esp_console_cmd_t cmd_delegate_host = {.command = "mdns_delegate_host",
...
static void register_mdns_undelegate_host(void) {
  ...
  const esp_console_cmd_t cmd_undelegate_host = {.command = "mdns_undelegate_host",
...
static int cmd_mdns_service_subtype(int argc, char **argv) {
  ...
  if (!mdns_service_subtype_args.service->sval[0] || !mdns_service_subtype_args.proto->sval[0] ||
      !mdns_service_subtype_args.sub->sval[0]) {
    printf("ERROR: Bad arguments!\n");
    return 1;
  }
  const char *instance = NULL;
  ...
  ESP_ERROR_CHECK(mdns_service_subtype_add_for_host(instance, mdns_service_subtype_args.service->sval[0],
                                                    mdns_service_subtype_args.proto->sval[0], host,
                                                    mdns_service_subtype_args.sub->sval[0]));
  return 0;
}
...
static void register_mdns_service_subtype_set(void) {
  ...
  const esp_console_cmd_t cmd_service_sub = {.command = "mdns_service_subtype",
...
static int cmd_mdns_browse(int argc, char **argv) {
  ...
  mdns_browse_t *handle =
      mdns_browse_new(mdns_browse_args.service->sval[0], mdns_browse_args.proto->sval[0], mdns_browse_notifier);
  return handle ? 0 : 1;
}
...
static void register_mdns_browse(void) {
  ...
  const esp_console_cmd_t cmd_browse = {.command = "mdns_browse",
                                        .help = "Start browsing",
                                        .hint = NULL,
...
static void register_mdns_browse_del(void) {
  ...
  const esp_console_cmd_t cmd_browse_del = {.command = "mdns_browse_del",
                                            .help = "Stop browsing",
                                            .hint = NULL,
