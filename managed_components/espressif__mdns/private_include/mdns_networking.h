...
esp_err_t esp_netif_dhcpc_get_status(esp_netif_t *esp_netif, esp_netif_dhcp_status_t *status) { return ESP_OK; }
...
const char *esp_netif_get_ifkey(esp_netif_t *esp_netif) { return esp_netif->if_key; }
