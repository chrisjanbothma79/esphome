 ...
 */
/*
 * This config file commited in order to not run `idf.py reconfigure` each time when running fuzzer test. You can modify
 * it manually or run `idf.py reconfigure` to generate new one if needed. Espressif IoT Development Framework (ESP-IDF)
