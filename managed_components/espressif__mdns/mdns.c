...
void ALLOW_WEAK *mdns_mem_malloc(size_t size) { return heap_caps_malloc(size, MDNS_MEMORY_CAPS); }

void ALLOW_WEAK *mdns_mem_calloc(size_t num, size_t size) { return heap_caps_calloc(num, size, MDNS_MEMORY_CAPS); }

void ALLOW_WEAK mdns_mem_free(void *ptr) { heap_caps_free(ptr); }
...
void ALLOW_WEAK mdns_mem_task_free(void *ptr) { heap_caps_free(ptr); }
