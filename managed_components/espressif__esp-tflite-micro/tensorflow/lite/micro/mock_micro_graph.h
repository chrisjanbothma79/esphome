...
void RecordingMicroAllocator::PrintAllocations() const {
  ...
  PrintRecordedAllocation(RecordedAllocationType::kCompressionData, "Persistent compression data", "allocations");
...
TfLiteStatus RecordingMicroAllocator::AllocateCompressedTensorsList(const Model *model,
                                                                    SubgraphAllocations *subgraph_allocations) {
  RecordedAllocation allocations = SnapshotAllocationUsage();

  TfLiteStatus status = MicroAllocator::AllocateCompressedTensorsList(model, subgraph_allocations);
