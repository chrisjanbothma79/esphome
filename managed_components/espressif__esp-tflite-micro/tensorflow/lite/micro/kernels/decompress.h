...
void DecompressionState::DecompressToBufferWidth4_16(int8_t *buffer) {
  ...
  const uint8_t *value_table = static_cast<const uint8_t *>(comp_data_.data.lut_data->value_table);
  ...
  for (size_t channel = 0; channel < num_channels_; channel++) {
    ...
    if (count >= 16) {
      const uint64_t *indices = reinterpret_cast<const uint64_t *>(&compressed_indices_[current_offset >> 1]);
      ...
      while (count >= 16) {
        ...
        *reinterpret_cast<uint64_t *>(buffer) = value;
        ...
        value2 |= static_cast<uint64_t>(value_table[(index >> 44) & 0x0F]) << 16;
        value2 |= static_cast<uint64_t>(value_table[(index >> 40) & 0x0F]) << 24;
        value2 |= static_cast<uint64_t>(value_table[(index >> 52) & 0x0F]) << 32;
        value2 |= static_cast<uint64_t>(value_table[(index >> 48) & 0x0F]) << 40;
        value2 |= static_cast<uint64_t>(value_table[(index >> 60) & 0x0F]) << 48;
        value2 |= static_cast<uint64_t>(value_table[(index >> 56) & 0x0F]) << 56;
      ...
      current_offset = (reinterpret_cast<const uint8_t *>(indices) - compressed_indices_) << 1;
    }
...
void DecompressionState::DecompressToBufferWidth2_16(int8_t *buffer) {
  ...
  for (size_t channel = 0; channel < num_channels_; channel++) {
    ...
    // process elements in current channel in groups of 16
    if (count >= 16) {
      const uint32_t *indices = reinterpret_cast<const uint32_t *>(&compressed_indices_[current_offset >> 2]);
      ...
      current_offset = (reinterpret_cast<const uint8_t *>(indices) - compressed_indices_) << 2;
    }
...
void DecompressionState::DecompressToBufferWidth3_32(int8_t *buffer) {
  ...
  for (size_t channel = 0; channel < num_channels_; channel++) {
    ...
    if (count >= 32) {
      const uint32_t *indices = reinterpret_cast<const uint32_t *>(&compressed_indices_[(current_offset >> 5) * 12]);
      ...
      while (count >= 32) {
        ...
        value |= static_cast<uint64_t>(value_table[((index0 << 1) & 0b110) | ((index0 >> 15) & 0b1)]) << 16;
        value |= static_cast<uint64_t>(value_table[(index0 >> 12) & 0x07]) << 24;
        value |= static_cast<uint64_t>(value_table[(index0 >> 9) & 0x07]) << 32;
        value |= static_cast<uint64_t>(value_table[((index0 >> 6) & 0b100) | ((index0 >> 22) & 0b11)]) << 40;
        value |= static_cast<uint64_t>(value_table[(index0 >> 19) & 0x07]) << 48;
        value |= static_cast<uint64_t>(value_table[(index0 >> 16) & 0x07]) << 56;

        *reinterpret_cast<uint64_t *>(buffer) = value;

        value2 = static_cast<uint64_t>(value_table[(index0 >> 29) & 0x07]);
        value2 |= static_cast<uint64_t>(value_table[(index0 >> 26) & 0x07]) << 8;
        value2 |= static_cast<uint64_t>(value_table[((index0 >> 23) & 0b110) | ((index1 >> 7) & 0b1)]) << 16;
        value2 |= static_cast<uint64_t>(value_table[(index1 >> 4) & 0x07]) << 24;
        value2 |= static_cast<uint64_t>(value_table[(index1 >> 1) & 0x07]) << 32;
        value2 |= static_cast<uint64_t>(value_table[((index1 << 2) & 0b100) | ((index1 >> 14) & 0b11)]) << 40;
        value2 |= static_cast<uint64_t>(value_table[(index1 >> 11) & 0x07]) << 48;
        value2 |= static_cast<uint64_t>(value_table[(index1 >> 8) & 0x07]) << 56;

        *reinterpret_cast<uint64_t *>(buffer + 8) = value2;

        value = static_cast<uint64_t>(value_table[(index1 >> 21) & 0x07]);
        value |= static_cast<uint64_t>(value_table[(index1 >> 18) & 0x07]) << 8;
        value |= static_cast<uint64_t>(value_table[((index1 >> 15) & 0b110) | ((index1 >> 31) & 0b1)]) << 16;
        value |= static_cast<uint64_t>(value_table[(index1 >> 28) & 0x07]) << 24;
        value |= static_cast<uint64_t>(value_table[(index1 >> 25) & 0x07]) << 32;
        value |= static_cast<uint64_t>(value_table[((index1 >> 22) & 0b100) | ((index2 >> 6) & 0b11)]) << 40;
        ...
        *reinterpret_cast<uint64_t *>(buffer + 16) = value;
        ...
        value2 |= static_cast<uint64_t>(value_table[(index2 >> 10) & 0x07]) << 8;
        value2 |= static_cast<uint64_t>(value_table[((index2 >> 7) & 0b110) | ((index2 >> 23) & 0b1)]) << 16;
        value2 |= static_cast<uint64_t>(value_table[(index2 >> 20) & 0x07]) << 24;
        value2 |= static_cast<uint64_t>(value_table[(index2 >> 17) & 0x07]) << 32;
        value2 |= static_cast<uint64_t>(value_table[((index2 >> 14) & 0b100) | ((index2 >> 30) & 0b11)]) << 40;
        value2 |= static_cast<uint64_t>(value_table[(index2 >> 27) & 0x07]) << 48;
        value2 |= static_cast<uint64_t>(value_table[(index2 >> 24) & 0x07]) << 56;
...
template<typename T> void DecompressionState::DecompressToBufferWidthAny(T *buffer) {
  ScopedMicroProfiler scoped_profiler(__func__, micro_profiler_);
  ...
  if (comp_data_.data.lut_data->use_alternate_axis) {
    ...
    while (count > 0) {
      const T *value_table = static_cast<const T *>(comp_data_.data.lut_data->value_table);
      for (size_t channel = 0; channel < num_channels_; channel++) {
        size_t index;
...
inline size_t DecompressionState::GetNextTableIndexWidth7(const size_t current_offset) {
...
inline size_t DecompressionState::GetNextTableIndexWidth6(const size_t current_offset) {
...
inline size_t DecompressionState::GetNextTableIndexWidth5(const size_t current_offset) {
...
inline size_t DecompressionState::GetNextTableIndexWidth4(const size_t current_offset) {
  if (current_offset & 1) {
...
inline size_t DecompressionState::GetNextTableIndexWidth3(const size_t current_offset) {
...
inline size_t DecompressionState::GetNextTableIndexWidth2(const size_t current_offset) {
...
inline size_t DecompressionState::GetNextTableIndexWidth1(const size_t current_offset) {
