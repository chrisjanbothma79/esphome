...
void WeatherStation2032Protocol::setup() {
  ...
  this->nbits_ = 111;
  this->repeat_ = 3;
  this->flags_ = WeatherStationFlag::TYPE_PPM | WeatherStationFlag::REVERSED;
}
...
void WeatherStation4LDProtocol::setup() {
  ...
  this->nbits_ = 52;
  this->repeat_ = 7;
  this->flags_ = WeatherStationFlag::TYPE_PPM | WeatherStationFlag::INVERTED | WeatherStationFlag::REVERSED;
}
...
void WeatherStationBresser3CHProtocol::setup() {
  ...
  this->nbits_ = 40;
  this->repeat_ = 8;
  this->flags_ = WeatherStationFlag::TYPE_PWM;
}
...
void WeatherStationH10515Protocol::setup() {
  ...
  this->nbits_ = 36;
  this->repeat_ = 8;
  this->flags_ = WeatherStationFlag::TYPE_PPM;
}
