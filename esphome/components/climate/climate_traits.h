...
class ClimateTraits {
 public:
  ...
  void set_supported_pellet_modes(std::set<ClimatePelletMode> modes) { supported_pellet_modes_ = std::move(modes); }
  void add_supported_pellet_mode(ClimatePelletMode mode) { supported_pellet_modes_.insert(mode); }
  bool supports_pellet_modes(ClimatePelletMode pellet_mode) const { return supported_pellet_modes_.count(pellet_mode); }
  bool get_supports_pellet_modes() const { return !supported_pellet_modes_.empty(); }
  const std::set<ClimatePelletMode> &get_supported_pellet_modes() const { return supported_pellet_modes_; }
  void set_supports_pellet_modes(bool supports_pellet_modes) { supports_pellet_modes_ = supports_pellet_modes; }
 ...
 protected:
  ...
  void set_pellet_mode_support_(climate::ClimatePelletMode mode, bool supported) {
    if (supported) {
  ...
  bool supports_pellet_modes_{false};
  std::set<climate::ClimateMode> supported_modes_ = {climate::CLIMATE_MODE_OFF};
  bool supports_action_{false};
  std::set<climate::ClimateFanMode> supported_fan_modes_;
  std::set<climate::ClimateEcoMode> supported_eco_modes_;
  std::set<climate::ClimatePelletMode> supported_pellet_modes_;
