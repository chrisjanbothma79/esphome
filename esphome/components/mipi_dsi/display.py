...
MIPI_DSI = mipi_dsi_ns.class_("MIPI_DSI", display.Display, cg.Component, spi.SPIDevice)
ColorOrder = display.display_ns.enum("ColorMode")
MIPI_DSI_DELAY_FLAG = 0xFF
...
def map_sequence(value):
    ...
    if isinstance(value, str) and value.lower().startswith("delay "):
        ...
        return [delay, MIPI_DSI_DELAY_FLAG]
...
FINAL_VALIDATE_SCHEMA = spi.final_validate_device_schema(
    "mipi_dsi", require_miso=False, require_mosi=True
)
