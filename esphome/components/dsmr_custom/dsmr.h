...
// No incluir <dsmr.h> porque pone todo en el espacio de nombres global
#include "parser.h"
#include "fields.h"
...
// Las listas DSMR_**_LIST son generadas por ESPHome y escritas en esphome/core/defines

#if !defined(DSMR_SENSOR_LIST) && !defined(DSMR_TEXT_SENSOR_LIST)
// Si ninguna está definida, se establece un valor ficticio para no romper la compilación
...
#define DSMR_SET_TEXT_SENSOR(s) \
 ...
 protected:
  ...
  // Función de ayuda para obtener el tiempo en milisegundos de forma agnóstica al framework
  uint32_t millis_();
...
// Punteros a miembros de sensores
