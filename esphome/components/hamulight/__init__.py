...
CONFIG_SCHEMA = cv.Schema({
    ...
    cv.Required("rf_transmit_pin"): gpio.GPIO_OUTPUT_SCHEMA,                                    # required PIN for RF transmission
    cv.Optional("led_pin"): gpio.GPIO_OUTPUT_SCHEMA,                                            # optional PIN for feedback LED
