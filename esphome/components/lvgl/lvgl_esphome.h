...
inline void lv_img_set_src(lv_obj_t *obj, image::Image *image) { lv_img_set_src(obj, image->get_lv_img_dsc()); }
inline void lv_disp_set_bg_image(lv_disp_t *disp, image::Image *image) {
  lv_disp_set_bg_image(disp, image->get_lv_img_dsc());
}

inline void lv_obj_set_style_bg_img_src(lv_obj_t *obj, image::Image *image, lv_style_selector_t selector) {
...
inline lv_meter_indicator_t *lv_meter_add_needle_img(lv_obj_t *obj, lv_meter_scale_t *scale, image::Image *src,
