...
stateDiagram-v2
    ...
    CLIENT_HELLO --> EXPLICIT_REJECT: BAD_INDICATOR/BAD_HANDSHAKE_PACKET_LEN
    SERVER_HELLO --> HANDSHAKE: send server hello
    HANDSHAKE --> DATA: handshake complete
    HANDSHAKE --> EXPLICIT_REJECT: BAD_INDICATOR/BAD_HANDSHAKE_PACKET_LEN/etc
    EXPLICIT_REJECT --> FAILED: after sending reject
    
    INITIALIZE --> FAILED: TCP_NONBLOCKING_FAILED/TCP_NODELAY_FAILED
    CLIENT_HELLO --> FAILED: SOCKET_READ_FAILED/CONNECTION_CLOSED
    SERVER_HELLO --> FAILED: SOCKET_WRITE_FAILED/HANDSHAKESTATE_SETUP_FAILED
    HANDSHAKE --> FAILED: HANDSHAKESTATE_READ_FAILED/HANDSHAKESTATE_WRITE_FAILED
    DATA --> FAILED: CIPHERSTATE_DECRYPT_FAILED/BAD_DATA_PACKET
...
stateDiagram-v2
    ...
    INITIALIZE --> FAILED: TCP_NONBLOCKING_FAILED/TCP_NODELAY_FAILED
    DATA --> FAILED: SOCKET_READ_FAILED/CONNECTION_CLOSED/BAD_INDICATOR/BAD_DATA_PACKET/SOCKET_WRITE_FAILED
