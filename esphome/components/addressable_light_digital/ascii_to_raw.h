...
const uint8_t ASCII_TO_RAW[] PROGMEM = {
    ...
    0b01001000,    // ':', ord 0x3A
    0b01011000,    // ';', ord 0x3B
    UNKNOWN_CHAR,  // '<', ord 0x3C
    UNKNOWN_CHAR,  // '=', ord 0x3D
    UNKNOWN_CHAR,  // '>', ord 0x3E
    0b01100101,    // '?', ord 0x3F
    0b01101111,    // '@', ord 0x40
    ...
    UNKNOWN_CHAR,  // 'K', ord 0x4B
    0b00001110,    // 'L', ord 0x4C
    UNKNOWN_CHAR,  // 'M', ord 0x4D
