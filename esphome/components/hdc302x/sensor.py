...
HDC302XWaterCalibrationAction = hdc302x_ns.class_(
    "HDC302XWaterCalibrationAction", automation.Action
)
HDC302XNewI2cAddressAction = hdc302x_ns.class_(
    "HDC302XNewI2cAddressAction", automation.Action
)
    ...
    cv.Schema(
        {
            ...
            cv.Optional('last_error'): sensor.sensor_schema(
                unit_of_measurement=UNIT_PERCENT,
                accuracy_decimals=1,
                device_class=DEVICE_CLASS_HUMIDITY,
                state_class=STATE_CLASS_MEASUREMENT,
...
@automation.register_action(
    "hdc302x.water_calibration",
    HDC302XWaterCalibrationAction,
    HDC302X_CALIBRATION_SCHEMA,
)
