...
void Sdl::setup() {
  ...
  this->window_ = SDL_CreateWindow(
      App.get_name().c_str(), this->pos_x_, this->pos_y_, this->width_, this->height_,
      SDL_WINDOW_RESIZABLE | this->borderless_ | this->always_on_top_ | this->fullscreen_ | this->skip_taskbar_);
