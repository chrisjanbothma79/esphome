...
uint8_t Adafruit_14seg::send_to_display(i2c::I2CDevice *display, uint8_t position) {
  ...
  const std::unordered_map<char, uint16_t> char_map = {
      ...
      {'p', 0b0000010001110001},
      {'q', 0b0010000011100011},
...
uint8_t Adafruit_14seg_flip::send_to_display(i2c::I2CDevice *display, uint8_t position) {
  ...
  const std::unordered_map<char, uint16_t> char_map = {
        ...
        { '5', 0b0000000110001101 },
        { '6', 0b0000000011101111 },
        { '7', 0b0000101000001000 },
        { '8', 0b0000000011111111 },
        ...
        { ']', 0b0000000000111001 },
        { '^', 0b0000000000011100 },
        { '_', 0b0000000000000001 },
        { '`', 0b0010000000000000 },
        { 'a', 0b0000001010000011 },
        { 'b', 0b0000000110000111 },
        { 'c', 0b0000000011000011 },
        { 'd', 0b0000010001110001 },
        { 'e', 0b0000010010000011 },
        { 'f', 0b0000000010001110 },
        { 'g', 0b0010000001111001 },
        { 'h', 0b0000001010000110 },
        { 'i', 0b0000001000000000 },
        { 'j', 0b0000000000110001 },
        { 'k', 0b0001101100000000 },
        { 'l', 0b0000000000000110 },
        { 'm', 0b0000001011100010 },
        { 'n', 0b0000001010000010 },
        { 'o', 0b0000000011100011 },
        { 'p', 0b0000100010001110 },
        { 'q', 0b0000000111011100 },
        { 'r', 0b0000000010000010 },
        { 's', 0b0000000101000001 },
        { 't', 0b0000000010000111 },
        { 'u', 0b0000000000100011 },
        { 'v', 0b0000000100100000 },
        { 'w', 0b0000010100100010 },
        { 'x', 0b0000010111000000 },
        { 'y', 0b0001000001110001 },
        { 'z', 0b0000010010000001 },
        { '{', 0b0010010010001001 },
        { '|', 0b0001001000000000 },
        { '}', 0b0000100101001001 },
        { '~', 0b0000000011000000 },
